...
fn print_help() {
    println!(
        "realtime_play options:\n\
         ...
         --mode live: persistent JSON-line runtime protocol; reads one JSON object per line from stdin, writes one per line to stdout\n\
...
// object per line on stdout. Used by external runtime clients.
